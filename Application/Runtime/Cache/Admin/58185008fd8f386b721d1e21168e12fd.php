...
<div id="page-wrapper">
			...
			<div class="col-md-12 span_3">
				<div class="bs-example1" data-example-id="contextual-table">
					...
					<form class="form-horizontal" action="" method="get" enctype="multipart/form-data">
						<h3><a href="/register/index.php/Admin/Gife/add">新增设置</a></h3>
						<div class="form-group">
							<span style="margin-left: 300px"></span>
							类 型  <select style="width: 150px;height: 30px;" name="type">
							<option value="0">全部</option>
							<option value="1">上家</option>
 ...
 $i = 1; ?>
						<?php if(is_array($res)): foreach($res as $key=>$v): if(($i%2)==1){ echo "<tr class='active'>"; }else{ echo "<tr class='info'>"; } ?>
							...
							<th><?php if($v["type"] == 1): ?>上家<?php elseif($v["type"] == 2): ?>下家<?php endif; ?></th>
							<th><?php echo ($v["productname"]); ?></th>
							<th><?php echo ($v["num"]); ?></th>
							<th><a href="/register/index.php/Admin/Gife/delete/id/<?php echo ($v["id"]); ?>">删 除</a></th>
						</tr>
