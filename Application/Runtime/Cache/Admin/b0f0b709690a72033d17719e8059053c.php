		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
		    <table class="table">
		      ...
		      <?php if(is_array($re)): foreach($re as $key=>$v): if(($i%2)==1){ echo "<tr class='active'>"; }else{ echo "<tr class='info'>"; } ?>
		          ...
		          <td><?php if($manager == 2): ?><a href="/register/index.php/Admin/Index/userpwd/id/<?php echo ($v["id"]); ?>">修 改</a> | <a href="javascript:if(confirm('确认删除吗?'))window.location='/register/index.php/Admin/Index/userdelete/id/<?php echo ($v["id"]); ?>'">删 除</a><?php elseif($manager == 1): ?>暂无权限操作<?php endif; ?></td>
		        </tr>
