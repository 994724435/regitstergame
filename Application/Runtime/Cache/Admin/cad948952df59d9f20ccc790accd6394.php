						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="price" value="0" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="afterprice" value="0" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="life" value="0" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<!--<div class="form-group">-->
									...
									<!--<div class="col-sm-8">-->
										<!--<input type="number" name="landnum" value="1" class="form-control1" id="focusedinput" placeholder="">-->
									<!--</div>-->
									<!--<div class="col-sm-2">-->
										<!--<p class="help-block"></p>-->
									<!--</div>-->
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="fruits" value="1" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="number" name="stealfruits" value="0" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<!--<div class="form-group">-->
									<!--<label for="focusedinput" class="col-sm-2 control-label">库存量（个）</label>-->
									<!--<div class="col-sm-8">-->
										<!--<input type="number" name="num" value="0" class="form-control1" id="focusedinput" placeholder="">-->
									<!--</div>-->
									<!--<div class="col-sm-2">-->
										<!--<p class="help-block"></p>-->
									<!--</div>-->
