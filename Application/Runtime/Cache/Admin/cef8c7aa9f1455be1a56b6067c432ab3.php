...
<!--    -->
    ...
    <div class="content_bottom">
		<?php if($manager == 2): ?><h3>充值待审核</h3><?php endif; ?>
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
		    <table class="table">
		      ...
		      <?php if(is_array($res)): foreach($res as $key=>$v): if(($i%2)==1){ echo "<tr class='active'>"; }else{ echo "<tr class='info'>"; } ?>
				  ...
				  <td><?php echo ($v["addtimes"]); ?></td>
				  <td><?php echo ($v["income"]); ?></td>
		          <td><?php if($manager == 2): ?><a href="/register/index.php/Admin/Menber/ischarge/id/<?php echo ($v["id"]); ?>/state/1">通 过</a> | <a href="/register/index.php/Admin/Menber/ischarge/id/<?php echo ($v["id"]); ?>/state/2">不 通 过</a><?php elseif($manager == 1): ?>暂无权限操作<?php endif; ?></td>
		        </tr>
