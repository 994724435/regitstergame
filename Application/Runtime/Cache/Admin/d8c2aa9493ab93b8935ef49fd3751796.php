						...
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">钱包</label>
									<div class="col-sm-8">
										<input type="text" name="incomebag" value="<?php echo ($user["incomebag"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" name="truename" value="<?php echo ($user["truename"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">用户类型</label>
									<div class="col-sm-8">
										<select class="form-control1" name="type">
											<option value="<?php echo ($user["type"]); ?>"><?php if($user["type"] == 1): ?>普通用户<?php elseif($user["type"] == 2): ?>VIP用户<?php endif; ?>
											</option>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">证件号码</label>
									<div class="col-sm-8">
										<input type="text" name="carnum" value="<?php echo ($user["carnum"]); ?>" class="form-control1" id="focusedinput" placeholder="">
									</div>
									<div class="col-sm-2">
										<p class="help-block"></p>
									</div>
