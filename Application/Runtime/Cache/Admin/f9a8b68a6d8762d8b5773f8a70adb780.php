                    ...
                    <ul class="nav" id="side-menu">
                      ...
                      <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/register/index.php/Admin/Article/lists">上家礼品</a>
                                </li>
                            </ul>
                        </li>
                        <!--<li>-->
		    ...
		    <table class="table">
		      <thead>
		        <tr style="text-align: center;">
		           <h3> <span><a href="/register/index.php/Admin/Article/addarticle">添加公告</a></h3>
		        </tr>
		        <tr>
		          <th>编号</th>
					<th>标题</th>
		      ...
		      <?php if(is_array($res)): foreach($res as $key=>$v): if(($i%2)==1){ echo "<tr class='active'>"; }else{ echo "<tr class='info'>"; } ?>
		          ...
		          <th style="width: 300px;max-height:300px;"><?php echo ($v["cont"]); ?></th>
				  <th><a href="/register/index.php/Admin/Article/editearticle/id/<?php echo ($v["aid"]); ?>">修改</a>|<a href="/register/index.php/Admin/Article/delete/id/<?php echo ($v["aid"]); ?>">删除</a></th>
				  <!--<th><a href="/register/index.php/Admin/Article/editearticle/id/<?php echo ($v["aid"]); ?>">修改</a></th>-->
			  </tr>
